...
namespace OmniResources.FansOfFuryPublicWeb.Mvc
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        {
            var tableUserStore = new TableUserStore<ApplicationUser>(ConfigurationManager.AppSettings["TableStorageConnectionString"]);
            var manager = new ApplicationUserManager(tableUserStore);
